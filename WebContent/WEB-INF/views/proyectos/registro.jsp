											...
											<div class="row">
												...
												<div class="col-lg-4 col-xs-12">
													...
													<div class="form-group">
														...
														<input type="number" class="form-control" id="latitud" disabled="disabled">
													</div>
													<div class="form-group">
														<label for="longitud">Longitud</label> 
														<input type="number" class="form-control" id="longitud" disabled="disabled">
													</div>
													
													<div id="alert_marker" class="alert alert-danger alert-dismissable">
									                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
									                    <h4><i class="icon fa fa-ban"></i> ¡Localización Incorrecta!</h4>
									                    La marca del mapa no puede estar fuera del área.
									                </div>
												</div>
...
// 				console.log(d.features[0].properties);
				var states = new Array();// = L.geoJson(d.features[0]).addTo(map);
				var pointCenter;
				...
				L.marker([ pointCenter[1], pointCenter[0] ], {
					...
					if (layer.length) {
						$("#latitud").val(this.getLatLng().lat);
						$("#longitud").val(this.getLatLng().lng);
// 						state.innerHTML = '<strong>' + layer[0].feature.properties.nombre_mun + '</strong>';
// 						console.log(layer[0].feature.properties);
						$("#alert_marker").hide();
					} else {
// 						state.innerHTML = '¡Ahí no!';
						$("#alert_marker").show();
					}
				});
			}
